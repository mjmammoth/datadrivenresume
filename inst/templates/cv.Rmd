...
Programming Language Proficiency {#skills}
--------------------------------------------------------------------------------
...
Training and Courses Attended {data-icon=chalkboard-teacher}
--------------------------------------------------------------------------------

```{r}
CV %<>% print_section("training_attended")
```



Certificates Awarded {data-icon=graduation-cap}
--------------------------------------------------------------------------------

::: aside
```{r}
CV %<>% print_text_block("certificates_awarded_aside")
```
:::

```{r}
CV %<>% print_section("certificates_awarded")
```
